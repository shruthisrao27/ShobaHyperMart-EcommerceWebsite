...
useEffect(() => {
  if (addresses.length > 0 && !selectedAddress) {
    setSelectedAddress(addresses[0]);  // ✅ first address auto-selected
  }
    ...
    total: getCartAmount() * 1.02,
    date: new Date().toLocaleString(),
  };
  if (paymentOption === "COD") {
    alert("Order placed successfully with Cash on Delivery!");
    console.log({ cartArray, selectedAddress, paymentOption });
    ...
    const amount = getCartAmount() * 1.02; // Total with tax
    const options = {
      key: "rzp_test_R9HGXfP6f1QAly", // 🔑 Replace with your Razorpay key
      amount: amount * 100, // Razorpay works in paisa
      currency: "INR",
      name: "Shoba Hyper Mart",
      description: "Order Payment",
      image: "/logo.png", // optional logo from public folder
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        >
                                            {Array(Math.min(cartItems[product._id], 9) || 9)
                                                .fill('')
                                                .map((_, index) => (
              ...
              Add address
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    ...
                    <p className="flex justify-between text-lg font-medium mt-3">
                        ...
                        <span>{currency}{getCartAmount() * 1.02}</span>
                    </p>
                </div>
